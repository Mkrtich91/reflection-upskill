...
namespace Reflection.Tests
{
    ...
    public class ReflectionOperationsTests
    {
        ...
        {
            new object[] { new MyClass(), "MyClass" },
            new object[] { new Employee(101, "Rahul", 22, "JSE", 600000, 45000), "Employee" },
        };

        private static readonly object[][] GetFullTypeNameData = new object[][]
        {
            new object[] { typeof(MyClass), "Reflection.Tests.MyClass" },
            new object[] { typeof(Employee), "Reflection.Tests.Employee" },
        };

        private static readonly object[][] GetAssemblyQualifiedNameData = new object[][]
        {
            new object[] { typeof(MyClass), "Reflection.Tests.MyClass, Reflection.Tests, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null" },
            new object[] { typeof(Employee), "Reflection.Tests.Employee, Reflection.Tests, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null" },
        };

        private static readonly object[][] GetPrivateInstanceFieldsData = new object[][]
        {
            new object[] { new MyClass(), new string[] { "intField" }, },
            new object[] { new Employee(101, "Rahul", 22, "JSE", 600000, 45000), new string[] { "<Id>k__BackingField", "<Name>k__BackingField", "<Age>k__BackingField", "<Role>k__BackingField", "<SalaryPerAnnum>k__BackingField", "<SalaryPerYear>k__BackingField" } },
        };

        private static readonly object[][] GetPublicStaticFieldsData = new object[][]
        {
            new object[] { new MyClass(), new string[] { "StaticIntField" }, },
            new object[] { new Employee(101, "Rahul", 22, "JSE", 600000, 45000), Array.Empty<string>() },
        };

        private static readonly object[][] GetInterfaceData = new object[][]
        {
            new object[] { new Employee(103, "Suresh", 23, "SE", 700000, 55000), new string[] { "Reflection.Tests.IEmployee" }, },
        };

        private static readonly object[][] GetConstructorsData = new object[][]
        {
            new object[] { new Employee(104, "Salman", 24, "SE", 700000, 55000), new string[] { "Void .ctor(Int32, System.String, Int32, System.String, Int32, Int32)" }, },
        };
        ...
        private static readonly object[][] GetTypeMembersData = new object[][]
        {
            new object[]
            {
                new Employee(105, "Chris", 27, "SSE", 1000000, 100000), new string[]
                {
                    "Int32 get_Id()",
                    "Void set_Id(Int32)",
                    ...
                    "Void .ctor(Int32, System.String, Int32, System.String, Int32, Int32)",
                    "Int32 Id",
                    "System.String Name",
                    "Int32 Age",
                    "System.String Role",
        ...
        private static readonly object[][] GetMethodData = new object[][]
        {
            new object[]
            {
                new Employee(106, "John", 25, "SSE", 1000000, 100000), new string[]
                {
                    "Int32 get_Id()",
                    "Void set_Id(Int32)",
                    "System.String get_Name()",
        ...
        private static readonly object[][] GetPropertiesData = new object[][]
        {
            new object[]
            {
                new Employee(108, "Vivek", 24, "JSE", 600000, 45000), new string[]
                {
                    "Int32 Id", "System.String Name", "Int32 Age", "System.String Role", "Int32 SalaryPerAnnum", "Int32 SalaryPerYear",
                },
            },
        };
        ...
        {
            // Arrange
            MethodInfo? methodInfo = typeof(ReflectionOperations).GetMethod(nameof(ReflectionOperations.GetFullTypeName), BindingFlags.Static | BindingFlags.Public);
        ...
        {
            // Arrange
            MethodInfo? methodInfo = typeof(ReflectionOperations).GetMethod(nameof(ReflectionOperations.GetAssemblyQualifiedName), BindingFlags.Static | BindingFlags.Public);
            MethodInfo genericMethodInfo = methodInfo!.MakeGenericMethod(type);
